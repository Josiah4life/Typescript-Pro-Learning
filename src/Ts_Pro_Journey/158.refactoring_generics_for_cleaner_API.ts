...
/**
 * In this implementation, we need to specify the theme inside useStyled wherever we use it.
 * This is not ideal.
 *
 * See if you can refactor useStyled into a function called makeUseStyled which returns a
 * useStyled function, typed with the theme
 *
 * Desired API:
 *
